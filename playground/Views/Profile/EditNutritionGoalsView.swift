...
struct EditNutritionGoalsView: View {
    ...
    @ViewBuilder
    private var goalStatusHeader: some View {
        ProfileSectionCard {
            GoalSummaryHeader(
                isAutoGenerated: viewModel.goalsAreAutoGenerated,
                lastUpdatedText: viewModel.goalsLastUpdatedText,
                isCustomized: viewModel.goalsAreCustomized
            )
        }
    }
        ...
        VStack(alignment: .leading, spacing: 8) {
            ...
            ProfileSectionCard {
                ...
                NutritionGoalCard(
                    ...
                    unit: "cal",
                    progress: 0.75,
                    recommendedDifference: viewModel.recommendedDifferences.calories
                ) {
                    tempCalories = viewModel.calorieGoal
                ...
                NutritionGoalCard(
                    ...
                    unit: "g",
                    progress: 0.5,
                    recommendedDifference: Int(viewModel.recommendedDifferences.protein)
                ) {
                    tempProtein = viewModel.proteinGoal
                ...
                NutritionGoalCard(
                    ...
                    unit: "g",
                    progress: 0.65,
                    recommendedDifference: Int(viewModel.recommendedDifferences.carbs)
                ) {
                    tempCarbs = viewModel.carbsGoal
                    isEditingCarbs = true
                }
                ...
                NutritionGoalCard(
                    ...
                    unit: "g",
                    progress: 0.4,
                    recommendedDifference: Int(viewModel.recommendedDifferences.fat)
                ) {
                    tempFat = viewModel.fatGoal
                    isEditingFat = true
                }
    ...
    // MARK: - Recommended Comparison Section
    
    @ViewBuilder
    private var recommendedComparisonSection: some View {
        // Only show if goals are customized (different from recommended)
        if viewModel.goalsAreCustomized {
            VStack(alignment: .leading, spacing: 8) {
                ProfileSectionHeader(title: "Comparison with Recommended")
                
                ProfileSectionCard {
                    VStack(spacing: 12) {
                        MacroDifferenceRow(
                            title: localizationManager.localizedString(for: AppStrings.Home.calories),
                            currentValue: Double(viewModel.calorieGoal),
                            recommendedValue: Double(viewModel.recommendedCalorieGoal),
                            unit: " cal",
                            color: .orange
                        )
                        ...
                        MacroDifferenceRow(
                            title: localizationManager.localizedString(for: AppStrings.Home.protein),
                            currentValue: viewModel.proteinGoal,
                            recommendedValue: viewModel.recommendedProteinGoal,
                            unit: "g",
                            color: .red
                        )
                        ...
                        MacroDifferenceRow(
                            title: localizationManager.localizedString(for: AppStrings.Home.carbs),
                            currentValue: viewModel.carbsGoal,
                            recommendedValue: viewModel.recommendedCarbsGoal,
                            unit: "g",
                            color: .orange
                        )
                        ...
                        MacroDifferenceRow(
                            title: localizationManager.localizedString(for: AppStrings.Home.fat),
                            currentValue: viewModel.fatGoal,
                            recommendedValue: viewModel.recommendedFatGoal,
                            unit: "g",
                            color: .blue
                        )
                    }
